...
TodoCubit({required this.getTodos, required this.addTodo, required this.deleteTodo, required this.toggleTodo})
: super(TodoState());
...
try {
final list = await getTodos(NoParams());
...
final t = Todo(id: _uuid.v4(), title: title, notes: notes, createdAt: DateTime.now());
